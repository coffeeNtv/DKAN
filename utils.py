...
def collate_fn(batch: tuple):
    """Custom collate function of train dataloader for DKAN.   
    ...
    text = torch.stack([item[8] for item in batch])
    
    return patch, exp, pid, sid, wsi, position, neighbors, mask, text
